...
const Home: NextPage = () => {
  return (
    <>
      <Head>
        <title>Farah Freight Group - Coming Soon</title>
        <meta name="description" content="Farah Freight Group - Coming Soon" />
        <meta
          name="keywords"
          content="Trucks, Transportation, Trucking, Trucking Canada, Trucking Ontario"
        />
      </Head>
